...
export default function Home() {
  return <>
    ...
    <header><div className="nav">
      <Link className="brand" href="/"><span className="mark">W</span><span><b>WorkWell by OHI</b><small>Occupational health, rebuilt around work</small></span></Link>
